...
import { useAnalysis } from "./context/analysis-context-provider";
				...
				<div className="max-w-4xl mx-auto text-center space-y-8">
					<div className="space-y-4">
						...
						<p className="text-lg text-gray-600 max-w-2xl mx-auto">
							...
							categorize them by topics, and provide sentiment analysis
					...
					<Card className="max-w-2xl mx-auto">
						<CardContent className="p-6">
							...
							<div className="mt-6">
								<Progress
									value={
										(analysisStep / (analysisSteps.length - 1)) * 100
									}
									className="h-2"
								/>
							</div>
