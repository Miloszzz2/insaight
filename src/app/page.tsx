	...
	const features = [
		{
			...
			description:
				"Understand your audience's true feelings with AI-powered sentiment detection",
		},
		{
			icon: "📊",
			title: "Smart Comment Grouping",
			description:
				"Automatically categorize comments by topics like editing, suggestions, and more",
		},
		{
			icon: "⚡",
			title: "Fast & Easy Analysis",
			description:
				"Get insights in seconds with just your YouTube login - no manual work required",
		},
		{
			icon: "🔒",
			title: "Secure & Private",
			description:
				"Your data stays safe with us - we never share or store your personal information",
		},
	];
	return (
		<div className="min-h-screen bg-white">
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center mb-16">
						<h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
							Why Creators Love CommentAI
						</h2>
						<p className="text-xl text-gray-600 max-w-2xl mx-auto">
							Powerful features designed to help you understand your
			...
			<section className="py-20 bg-gradient-to-r from-violet-600 to-purple-600 relative overflow-hidden">
				...
				<div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8 relative z-10">
					...
					<p
						className="text-xl text-violet-100 mb-8 animate-fade-in-up"
						style={{ animationDelay: "0.2s" }}
					>
						Join thousands of creators who are already using CommentAI to
						grow their channels
					</p>
					<div
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center">
						...
						<p className="text-gray-400 mb-4">
							AI-powered YouTube comment analysis for smarter content
							creation
						</p>
						<div className="text-sm text-gray-500">
							© 2025 InsAight. All rights reserved.
						</div>
					</div>
				</div>
			</footer>
