    ...
    <SidebarProvider>
      ...
      <SidebarInset>
        ...
        <header className="flex shrink-0 items-center gap-2 border-b px-4 py-4">
          ...
          <Badge variant="secondary" className="bg-violet-100 text-violet-700 text-sm">

          </Badge>
        </header>
        {/* Main Content */}
        <main className="flex-1 p-8 pt-0">
          <Suspense fallback={<div className="flex justify-center items-center h-full"> <Loader2 className="w-10 h-10 text-violet-600 animate-spin" /></div>}>
