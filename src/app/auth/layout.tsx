        ...
        <div className="flex min-h-screen">
            ...
            <div className="hidden lg:flex lg:w-1/2 bg-black p-12 items-center justify-center relative overflow-hidden">
                ...
                <div className="max-w-lg relative z-10">
                    {/* Quote Mark */}
                    <div className="text-9xl font-serif text-gray-700 absolute -top-20 -left-4 opacity-30">"</div>

                    <blockquote className="text-2xl text-white leading-relaxed mb-8">
                        Now things are starting to get interesting! YouTube comments have always been a goldmine of feedback, but
                        they're overwhelming to process manually. InsAight is the perfect solution for creators who want to
                    ...
                    <div className="flex items-center space-x-4">
                        <Avatar className="w-12 h-12 border-2 border-violet-600">
                            ...
                            <AvatarFallback className="bg-violet-900 text-white">SC</AvatarFallback>
                        </Avatar>
                        <div>
                            <div className="text-white font-medium">Sarah Chen</div>
                            <div className="text-gray-400">@sarahcreates • 1.2M subscribers</div>
                        </div>
                    </div>
                </div>
            </div>
