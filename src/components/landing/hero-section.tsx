...
export function HeroSection() {
   ...
   return (
      <section className="relative min-h-screen bg-gradient-to-br from-violet-900 via-purple-900 to-indigo-900 overflow-hidden">
         {/* Navigation */}
         <nav
            className={`relative z-10 px-4 sm:px-6 lg:px-8 py-6 transition-all duration-1000 ${isVisible ? "translate-y-0 opacity-100" : "-translate-y-10 opacity-0"}`}
         >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
               ...
               >
                  <div className="space-y-6">
                     ...
                     <p className="text-xl text-white/80 max-w-lg animate-fade-in-up" style={{ animationDelay: "0.8s" }}>
                        We team up with creators to unlock cutting-edge insights from YouTube comments. Let's build something
                        amazing together.
                     </p>
                  </div>
                  ...
                  {/* Stats */}
                  <div className="flex items-center space-x-8 pt-8 animate-fade-in-up" style={{ animationDelay: "1.2s" }}>
